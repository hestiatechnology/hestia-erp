...
type CreateCompanyRequest struct {
	...
	Ssn            uint32    `protobuf:"varint,5,opt,name=ssn,proto3" json:"ssn,omitempty"`
...
func (x *CreateCompanyRequest) GetSsn() uint32 {
	if x != nil {
		return x.Ssn
	}
	return 0
...
var file_company_management_proto_rawDesc = []byte{
	...
	0x0a, 0x03, 0x73, 0x73, 0x6e, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x03, 0x73, 0x73, 0x6e,
