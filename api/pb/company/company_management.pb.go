...
type CreateCompanyRequest struct {
	...
	VatId          string    `protobuf:"bytes,4,opt,name=vatId,proto3" json:"vatId,omitempty"`
	Ssn            uint64    `protobuf:"varint,5,opt,name=ssn,proto3" json:"ssn,omitempty"`
...
func (x *CreateCompanyRequest) GetVatId() string {
	if x != nil {
		return x.VatId
	}
	return ""
...
func (x *CreateCompanyRequest) GetSsn() uint64 {
	if x != nil {
		return x.Ssn
	}
	return 0
...
var file_company_management_proto_rawDesc = []byte{
	...
	0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x74, 0x49, 0x64, 0x12, 0x10,
	0x0a, 0x03, 0x73, 0x73, 0x6e, 0x18, 0x05, 0x20, 0x01, 0x28, 0x04, 0x52, 0x03, 0x73, 0x73, 0x6e,
