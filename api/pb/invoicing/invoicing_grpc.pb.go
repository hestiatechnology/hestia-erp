...
func (c *invoicingClient) NewInvoice(ctx context.Context, in *Invoice, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, Invoicing_NewInvoice_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *invoicingClient) GetInvoices(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListInvoices, error) {
	...
	err := c.cc.Invoke(ctx, Invoicing_GetInvoices_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *invoicingClient) GetInvoice(ctx context.Context, in *common.Id, opts ...grpc.CallOption) (*Invoice, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Invoice)
	err := c.cc.Invoke(ctx, Invoicing_GetInvoice_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedInvoicingServer must be embedded to have
...
func (UnimplementedInvoicingServer) testEmbeddedByValue()                   {}
...
func RegisterInvoicingServer(s grpc.ServiceRegistrar, srv InvoicingServer) {
	// If the following call pancis, it indicates UnimplementedInvoicingServer was
